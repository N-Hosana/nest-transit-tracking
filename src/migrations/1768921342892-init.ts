...
export class Init1768921342892 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "route_stops" DROP COLUMN "longitude"`);
        ...
        await queryRunner.query(`ALTER TABLE "route_stops" ADD "location" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "route" ADD "from" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "route" ADD "to" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "bus" ADD "currentLocation" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bus" DROP CONSTRAINT "FK_965c21e73b29c7266510b60cabb"`);
        ...
        await queryRunner.query(`ALTER TABLE "route_stops" ADD CONSTRAINT "FK_352e45964a86c097a435f643004" FOREIGN KEY ("routeId") REFERENCES "route"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bus" ADD CONSTRAINT "FK_965c21e73b29c7266510b60cabb" FOREIGN KEY ("routeId") REFERENCES "route"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bus" ADD "longitude" double precision`);
        await queryRunner.query(`ALTER TABLE "bus" ADD "latitude" double precision`);
        await queryRunner.query(`ALTER TABLE "route" ADD "description" character varying`);
        await queryRunner.query(`ALTER TABLE "route_stops" ADD "longitude" numeric(10,6) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "route_stops" ADD "latitude" numeric(10,6) NOT NULL`);
    }
